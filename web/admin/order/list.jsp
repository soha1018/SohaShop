...
<HEAD>
    ...
    <script type="text/javascript">
        ...
        function findOrderInfoByOid(oid) {
            ...
            $.post(
                "${pageContext.request.contextPath}/adminOrderProduct",
                {"oid":oid},
                function (data) {
                    //隐藏加载图片
        ...
        <tr>
            <td class="ta_01" align="center" bgColor="#f5fafe">
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <c:forEach items="${adminOrderList}" var="order" varStatus="vs">
...
<div id="showDiv" class="blk" style="display:none;">
    <div class="main">
        ...
        <div id="loading" style="padding-top:30px;text-align: center;">
            <img alt="" width="30%" height="50%" src="${pageContext.request.contextPath }/images/loading.gif">
        </div>

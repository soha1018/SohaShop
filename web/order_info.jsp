...
<div class="container">
                ...
                <c:forEach items="${order.orderItems}" var="item">
                    <tr class="active">
                        <td width="60" width="40%">
                            <img src="${pageContext.request.contextPath}/${item.product.pimage}" width="70px"
                                 height="60px">
                        </td>
    ...
    <div>
        <hr/>
        <form id="subOrder" class="form-horizontal" style="margin-top: 5px; margin-left: 150px;"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="username"
                           placeholder="请输入收货地址" value="${order.address}" name="address">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputPassword3"
                           placeholder="请输收货人" value="${user.username}" name="name">
                </div>
            </div>
            <div class="form-group">
